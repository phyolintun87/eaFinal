...
import mum.ea.controller.LoginController;
...
public class LoginPanel extends javax.swing.JFrame {
    ...
    public LoginPanel() {
        initComponents();
        usernameField.setText("umurinan");
    ...
    private void loginButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginButtonActionPerformed
        ...
        boolean result = loginController.login(loginModel);
        System.out.println("Result:"+result);
        System.out.println("Login Inf0:"+LoginHelper.getTypeId());
        
        if (result) {
            if(LoginHelper.getTypeId()==2){
               MainPanelStudent mainPanel = new MainPanelStudent();
               mainPanel.show();
               this.dispose();
            }
            else{
            ...
            JOptionPane.showMessageDialog(null, "Bad Credetials");
        }
